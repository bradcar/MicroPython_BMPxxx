...
# Set for suggested Indoor navigation resolution for bmp390
bmp.pressure_oversample_rate = bmp.OSR16
bmp.temperature_oversample_rate = bmp.OSR2
bmp.iir_coefficient = bmp.COEF_3
print("\nTesting 5 iterations with Indoor navigation resolution for bmp390")
print(f"{bmp.pressure_oversample_rate=}")
print(f"{bmp.temperature_oversample_rate=}")
...
# Set for suggested Drone resolution for bmp390
...
# Set for the suggested Weather station resolution for bmp390
